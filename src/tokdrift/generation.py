...
def parallel_generations(
    ...
    # Handle temperature=0.0 case: use greedy decoding (do_sample=False)
    if args.temperature == 0.0:
        do_sample = False
        temperature = 1.0  # Set to 1.0 to avoid the error, but do_sample=False means it won't be used
    else:
    ...
    # FIXME: debug
    # print(f"task.stop_words: {task.stop_words}")
