...
This is the code repository for the paper [TokDrift: When LLM Speaks in Subwords but Code Speaks in Grammar](https://arxiv.org/pdf/2510.14972) (ACL 2026 Main). TokDrift is a framework designed to apply semantic-preserving rewrite rules and measure their influence on various code-related tasks.
